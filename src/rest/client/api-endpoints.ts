const API_ENDPOINTS = {
  ...
  QUERY_USER_INFO: "api/v1/admin/user/queryUserInfo/",
  METRICS: "api/v1/admin/user/metrics",
  CAMPUSES: "api/v1/admin/university/campus",
  COUNSELLORS: "api/v1/admin/user/counsellors/",
  COUNSELLOR: "api/v1/admin/user/counsellor/",
  PEER_COUNSELLORS: "api/v1/admin/user/peercounsellors/",
  PEER_COUNSELLOR: "api/v1/admin/user/peercounsellor/",
